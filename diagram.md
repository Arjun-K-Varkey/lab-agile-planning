...
    AA[Vendor Arrives at Consumer]:::process
    ...
    %% NEW: Destination Volume Verification (CTO Enhancement)
    AAV{Destination Volume Verification}:::decision
...
    Z --> AA
    ...
    %% NEW: Destination Volume Verification Path
    AA --> AAV
    AAV -->|Discrepancy / Fraud| AC
    AAV -->|Verified| AB
    
    %% OTP Failure Path
